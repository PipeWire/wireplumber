-- Even with persistancy off default nodes scripts should give priority to the
-- current preferred device over and above the perviously preferend devices and
-- available devices.
