...
SimpleEventHook {
  name = "linkable-device-for-virtual-removed@policy-virtual",
  interests = {
    EventInterest {
...
SimpleEventHook {
  name = "rescan-device-for-virtual-session@policy-virtual",
  interests = {
    EventInterest {
  ...
  execute = function (event)
    ...
    for si_virtual in om:iterate {
      ...
      source:call ("push-event", "select-si-device-and-link", si, nil)
...
SimpleEventHook {
  name = "rescan-device-for-virtual-trigger@policy-virtual",
  interests = {
