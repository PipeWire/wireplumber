...
typedef enum
{
  ...
  WP_EVENT_HOOK_DEFAULT_PRIORITY_POLICY_TESTS_HOOK = WP_EVENT_HOOK_DEFAULT_PRIORITY_BASE,
  WP_EVENT_HOOK_DEFAULT_PRIORITY_LINK_TARGET_SI = WP_EVENT_HOOK_DEFAULT_PRIORITY_POLICY_TESTS_HOOK + PRIORITY_STEP,
